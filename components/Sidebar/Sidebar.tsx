...
function Sidebar() {
  ...
  return (
    <div className="hidden sm:flex flex-col items-center h-full fixed xl:items-end xl:p-2 border-r border-[#2F3336]">
      <div className="flex flex-col justify-between h-full xl:w-[275px] ">
        <div>
